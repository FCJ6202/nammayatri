...
getEn =
  Keymap
    ...
    , your_extra_charge_penalty : "Your Extra-Charge Penalty"
    , what_does_this_mean : "What does this mean?"
    , read_more : "Read More"
    , take_the_course : "Take the Course"
    , extra_charge_q1 : "What is Extra-Charge Penalty ?"
    , extra_charge_a1 : "If driver asks extra from customer, then the overcharging score will increase."
    , extra_charge_q2 : "What will happen if the penalty increases ?"
    , extra_charge_a2 : "Driver will get lesser rides if the score is high"
    , extra_charge_q3 : "How can I reduce my penalty ?"
    , extra_charge_a3 : "Take rides and do not demand extra. Over time the score will reduce."
    , extra_charge_q4 : "What if Driver does not stop asking extra ?"
    , extra_charge_a4 : "Driver will be suspended for a short duration. If driver continues asking extra, then driver will be blocked"
    , zero : "Zero"
    , low : "Low"
    , suspended : "Suspended"
    , blocked : "Blocked"
