...
driverBLockedPopup state =
  let
    ...
    title = if isOverCharging  && isSuspended then "Suspended till 4:15 PM, 15-09-2024 ⚠️"
    ...
    description = if isOverCharging && isSuspended then "Due to frequent overcharging, you are suspended from going online"
      else if isOverCharging then "Due to frequent overcharging, you are blocked from taking rides"
