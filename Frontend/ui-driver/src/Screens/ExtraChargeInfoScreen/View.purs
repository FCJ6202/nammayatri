  ...
  case state.driverInfoResp of
    Just (GetDriverInfoResp resp) ->
       case resp.overchargingTag of
        Just overchargingTag -> ExtraChargeCard.view (push <<< ExtraChargeCardAC) $ ExtraChargeCard.extraChargesConfig overchargingTag resp.ridesWithFareIssues resp.totalRidesConsideredForFareIssues
